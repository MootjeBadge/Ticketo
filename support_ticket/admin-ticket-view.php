...
<head>
    ...
    <title>Ticketo Chatsessie</title>
                                        ...
                                        <li class="reply-me">
                                            <div class="card bg-gray text-dark">
                                                <div class="card-body">
                                                    <p><?php echo $v['message']; ?></p>
                                                    <div class="text-right">
                                                        <small>Verzonden door Admin team <?php echo $v['date'];?></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                    ...
                    <div class="send-area">
                        <form method="POST">
                            <div class="form-group">
                                <textarea name="message" class="form-control" placeholder="Antwoord" id="message" cols="30" rows="4"></textarea>
                            </div>
                            <div class="form-group text-right">
                                <input type="hidden" name="submit" value="send">
                                <button class="btn btn-success" type="submit">Verzend</button>
                            </div>
                        </form>
                    </div>
                </div>
